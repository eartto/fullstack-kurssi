...
test('renders content', () => {
  ...
  const elements = screen.getAllByText('Testing blog', { exact: false })

  expect(elements[0]).toHaveTextContent('Testing blog', 'Testson')
})
...
test('renders after button press', async () => {
  ...
  expect(elements[1]).toHaveTextContent('testblog.com', 2)
})
